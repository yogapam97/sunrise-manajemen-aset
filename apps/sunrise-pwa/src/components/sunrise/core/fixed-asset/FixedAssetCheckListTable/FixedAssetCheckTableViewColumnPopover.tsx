...
type FixedAssetCheckTableViewColumnPopoverProps = {
  columns: any[];
  onChangeColumns: (columns: any[]) => void;
};

export default function FixedAssetCheckTableViewColumnPopover({
  columns,
  onChangeColumns,
}: FixedAssetCheckTableViewColumnPopoverProps) {
