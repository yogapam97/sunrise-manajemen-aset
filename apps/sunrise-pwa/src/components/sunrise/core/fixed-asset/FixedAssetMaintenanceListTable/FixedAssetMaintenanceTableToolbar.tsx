...
import FixedAssetMaintenanceTableViewColumnPopover from "./FixedAssetMaintenanceTableViewColumnPopover";

type FixedAssetMaintenanceTableToolbarProps = {
...
export default function FixedAssetMaintenanceTableToolbar({
  hideFilter,
  onSearch,
  onClickFilter,
  columns,
  ...
  onFullScreen,
  config,
}: FixedAssetMaintenanceTableToolbarProps) {
  ...
  return (
    <Stack sx={{ p: 1 }} direction="row" justifyContent="space-between">
      <Stack direction="row" spacing={1}>
        ...
        {columns?.length && (
          <FixedAssetMaintenanceTableViewColumnPopover
