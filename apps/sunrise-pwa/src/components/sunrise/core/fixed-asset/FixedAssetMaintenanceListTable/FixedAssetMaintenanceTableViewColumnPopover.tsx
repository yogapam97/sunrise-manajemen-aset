...
type FixedAssetMaintenanceTableViewColumnPopoverProps = {
  columns: any[];
  onChangeColumns: (columns: any[]) => void;
};

export default function FixedAssetMaintenanceTableViewColumnPopover({
  columns,
  onChangeColumns,
}: FixedAssetMaintenanceTableViewColumnPopoverProps) {
