...
const MaintenanceFilterSchema: Yup.ObjectSchema<any> = Yup.object().shape({
...
export default function MaintenanceFilterForm({
  defaultFilter,
  onFilter,
  config,
  ...
  const methods = useForm({
    resolver: yupResolver(MaintenanceFilterSchema),
    defaultValues,
  });
          ...
          <Stack spacing={1} direction="row" alignItems="center">
            <ButtonGroup size="small">
              <Button
                ...
                onClick={() => handleMaintenanceFilter("maintenance-in")}
              >
                Maintenance In
              </Button>
              <Button
                ...
                onClick={() => handleMaintenanceFilter("maintenance-out")}
              >
                Maintenance Out
              </Button>
            </ButtonGroup>
