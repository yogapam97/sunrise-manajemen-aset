...
type CheckFilterFormProps = {
  defaultFilter?: any;
  onFilter: (values: any) => void;
  config?: any;
};

const CheckFilterSchema: Yup.ObjectSchema<any> = Yup.object().shape({
...
export default function CheckFilterForm({ defaultFilter, onFilter, config }: CheckFilterFormProps) {
  ...
  const methods = useForm({
    resolver: yupResolver(CheckFilterSchema),
    defaultValues,
  });
  ...
  const handleCheckFilter = (status: string) => {
          ...
          <Stack spacing={1} direction="row" alignItems="center">
            <ButtonGroup size="small">
              <Button
                ...
                onClick={() => handleCheckFilter("check-in")}
              >
                Check In
              </Button>
              <Button
                ...
                onClick={() => handleCheckFilter("check-out")}
              >
                Check Out
              </Button>
            </ButtonGroup>
